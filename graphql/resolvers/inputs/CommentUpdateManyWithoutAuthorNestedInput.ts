...
export class CommentUpdateManyWithoutAuthorNestedInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [CommentUpsertWithWhereUniqueWithoutAuthorInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [CommentUpdateWithWhereUniqueWithoutAuthorInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [CommentUpdateManyWithWhereWithoutAuthorInput],
    {
      nullable: true,
    },
  )
