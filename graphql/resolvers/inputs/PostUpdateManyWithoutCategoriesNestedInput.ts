...
@TypeGraphQL.InputType("PostUpdateManyWithoutCategoriesNestedInput", {})
export class PostUpdateManyWithoutCategoriesNestedInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [PostUpsertWithWhereUniqueWithoutCategoriesInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [PostUpdateWithWhereUniqueWithoutCategoriesInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [PostUpdateManyWithWhereWithoutCategoriesInput],
    {
      nullable: true,
    },
  )
