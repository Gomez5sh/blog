...
import { PollUpdateManyWithoutPostNestedInput } from "../inputs/PollUpdateManyWithoutPostNestedInput";
...
@TypeGraphQL.InputType("PostUpdateWithoutQuestionsInput", {})
export class PostUpdateWithoutQuestionsInput {
  ...
  @TypeGraphQL.Field((_type) => PollUpdateManyWithoutPostNestedInput, {
    nullable: true,
  })
  polls?: PollUpdateManyWithoutPostNestedInput | undefined;
