...
@TypeGraphQL.InputType("CategoryUpdateManyWithoutPostsNestedInput", {})
export class CategoryUpdateManyWithoutPostsNestedInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [CategoryUpsertWithWhereUniqueWithoutPostsInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [CategoryUpdateWithWhereUniqueWithoutPostsInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [CategoryUpdateManyWithWhereWithoutPostsInput],
    {
      nullable: true,
    },
  )
