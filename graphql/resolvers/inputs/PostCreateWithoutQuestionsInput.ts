...
import { PollCreateNestedManyWithoutPostInput } from "../inputs/PollCreateNestedManyWithoutPostInput";
...
@TypeGraphQL.InputType("PostCreateWithoutQuestionsInput", {})
export class PostCreateWithoutQuestionsInput {
  ...
  @TypeGraphQL.Field((_type) => PollCreateNestedManyWithoutPostInput, {
    nullable: true,
  })
  polls?: PollCreateNestedManyWithoutPostInput | undefined;
