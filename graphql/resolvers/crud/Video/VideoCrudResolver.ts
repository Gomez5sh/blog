...
export class VideoCrudResolver {
  ...
  async createOneVideo(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateOneVideoArgs,
  ): Promise<Video> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteOneVideo(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteOneVideoArgs,
  ): Promise<Video | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstVideoOrThrow(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstVideoOrThrowArgs,
  ): Promise<Video | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getVideo(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniqueVideoOrThrowArgs,
  ): Promise<Video | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async updateOneVideo(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateOneVideoArgs,
  ): Promise<Video | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async upsertOneVideo(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertOneVideoArgs,
  ): Promise<Video> {
    const { _count } = transformInfoIntoPrismaArgs(info);
