...
export class ProfileCrudResolver {
  ...
  async createOneProfile(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateOneProfileArgs,
  ): Promise<Profile> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteOneProfile(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteOneProfileArgs,
  ...
  async findFirstProfileOrThrow(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstProfileOrThrowArgs,
  ): Promise<Profile | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getProfile(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniqueProfileOrThrowArgs,
  ): Promise<Profile | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async upsertOneProfile(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertOneProfileArgs,
  ): Promise<Profile> {
    const { _count } = transformInfoIntoPrismaArgs(info);
