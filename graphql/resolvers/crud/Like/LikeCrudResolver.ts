...
export class LikeCrudResolver {
  ...
  async createOneLike(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateOneLikeArgs,
  ): Promise<Like> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteOneLike(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteOneLikeArgs,
  ): Promise<Like | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstLikeOrThrow(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstLikeOrThrowArgs,
  ): Promise<Like | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getLike(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniqueLikeOrThrowArgs,
  ): Promise<Like | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async updateOneLike(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateOneLikeArgs,
  ): Promise<Like | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async upsertOneLike(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertOneLikeArgs,
  ): Promise<Like> {
    const { _count } = transformInfoIntoPrismaArgs(info);
