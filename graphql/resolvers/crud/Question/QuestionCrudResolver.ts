...
export class QuestionCrudResolver {
  ...
  async aggregateQuestion(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: AggregateQuestionArgs,
  ): Promise<AggregateQuestion> {
  ...
  async createManyQuestion(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyQuestionArgs,
  ...
  async createOneQuestion(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateOneQuestionArgs,
  ): Promise<Question> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteManyQuestion(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteManyQuestionArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteOneQuestion(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteOneQuestionArgs,
  ...
  async findFirstQuestion(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstQuestionArgs,
  ): Promise<Question | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstQuestionOrThrow(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstQuestionOrThrowArgs,
  ): Promise<Question | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async questions(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindManyQuestionArgs,
  ): Promise<Question[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async question(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniqueQuestionArgs,
  ): Promise<Question | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getQuestion(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniqueQuestionOrThrowArgs,
  ): Promise<Question | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async groupByQuestion(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: GroupByQuestionArgs,
  ): Promise<QuestionGroupBy[]> {
  ...
  async updateManyQuestion(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateManyQuestionArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async updateOneQuestion(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateOneQuestionArgs,
  ): Promise<Question | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async upsertOneQuestion(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertOneQuestionArgs,
  ): Promise<Question> {
    const { _count } = transformInfoIntoPrismaArgs(info);
